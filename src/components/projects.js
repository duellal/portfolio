...
//Project Images:
import atomicChessOutput from "../static/images/atomic-chess-initial-and-end-board-python-output.png"
...
import projectWebsite from '../static/images/duellal-a8-screenshot.png'
        ...
        <section id="projects">
            ...
            <div className="project-div left">
                <h4 className="left-title">
                    <a href="https://aduellportfolio.netlify.app/" target="new">
                        OSU Portfolio Website
                    </a>
                </h4>
                <div className="text-box">
                    <div className="text-box border">
                        <img className="github left" src={gitHub} onClick={() => {
                            window.open(`https://github.com/duellal/a8-portfolio`)
                        }} />
                        <div className="p-div left">
                            <p>
                                This <a href="https://aduellportfolio.netlify.app/" target="new">
                                    website {' '}
                                </a>
                                was built to showcase my knowledge in Frontend and Backend development over the course of a few months. On this website you can find my knowledge in computer science topics, be able to see and manipulate a table for Air Hockey Tournament matches, find board games that are randomly generated by an external API, see a gallery of photos, and there are two different forms: an order form and a contact form. 
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="pic">
                    <img src={projectWebsite} className="npc-pic" loading="lazy" alt="" />
                </div>
            </div>
           
            <div className="project-div right">
                <h4 className="right-title">
                    <a href="https://github.com/duellal/atomic-chess" target="new">
                        Atomic Chess
                    </a>
                </h4>
                <div className="pic">
                    <img src={atomicChessOutput} className="npc-pic" loading="lazy" alt="" />
                </div>
                <div className="text-box">
                    <div className="text-box border">
                        <div className="p-div right">
                            <p>
                                This project was one I coded for a class at Oregon State University using Python. The project was to create an <a href="https://www.chess.com/terms/atomic-chess" target="new">Atomic Chess</a> game using classes and logic. 
                            </p>

                            <p>
                                During this project, I had to think about how each piece on the board moves and how they interact with each other. On top of that, I had to understand how the atomic chess rules worked and how to incorporate that into the game logic. This project has a lot of moving parts (figuratively and literally speaking) that was a fun and, at times, mind-boggling experience.
                            </p>
                        </div>
                        <img className="github right" src={gitHub} onClick={() => {
                            window.open(`https://github.com/duellal/atomic-chess`)
                        }} />
                    </div>
                </div>
            </div>
